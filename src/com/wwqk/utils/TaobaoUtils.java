...
//						HSSFCell promotion_end = hssfRow.getCell(13);
						HSSFCell store_ww = hssfRow.getCell(9);
						HSSFCell tbk_short_url = hssfRow.getCell(10);
						HSSFCell tbk_url = hssfRow.getCell(11);
						HSSFCell tkl = hssfRow.getCell(12);
						HSSFCell coupon_count = hssfRow.getCell(13);
						HSSFCell coupon_count_last = hssfRow.getCell(14);
						HSSFCell coupon_desc = hssfRow.getCell(15);
						HSSFCell coupon_start = hssfRow.getCell(16);
						HSSFCell coupon_end = hssfRow.getCell(17);
						HSSFCell coupon_url = hssfRow.getCell(18);
						HSSFCell coupon_tkl = hssfRow.getCell(19);
						HSSFCell coupon_short_url = hssfRow.getCell(20);
