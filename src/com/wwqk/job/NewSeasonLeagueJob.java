...
/**
 * 新赛季更新球队
 * !!!!!!!!! 在运行之前一定要备份数据库，一定要把图片下载下来放到本地
 *
 */
public class NewSeasonLeagueJob implements Job {
	...
	public void execute(JobExecutionContext arg0) throws JobExecutionException {
		System.err.println("NewSeasonLeagueJob start!!!");
		//更新联赛中球队
		updateTeamsInLeague();
		System.err.println("NewSeasonLeagueJob end!!!");
	}
	...
	private void updateTeamsInLeague(){
		...
		try {
			for(League league : leagues){
				...
				updateTeamAndVenueImage(league.getStr("id"));
			}
		} catch (Exception e) {
	...
	private void updateAllTeams(String leagueUrl, String leagueId) throws IOException{
	 ...
	 * 更新球队和球场图片
	 */
	private void updateTeamAndVenueImage(String leagueId) {
