					...
					<table class="table small-table" >
							  ...
							  <tbody>
							  		<c:forEach items="${lstMatchHistory}" var="history">
							  			<tr>
							  				<td class="a-title tleft" style="width:40%;"><a href="team-${history.home_team_en_name}-${history.home_team_id}.html" target="_blank"><img src="assets/image/soccer/teams/25x25/${history.home_team_id}.png" class="w25h25" alt="${history.home_team_name}" title="${history.home_team_name}"/> ${history.home_team_name}</a></td>
							  				...
							  				<td class="a-title tleft" style="width:40%;">&nbsp;&nbsp;&nbsp;<a href="team-${history.away_team_en_name}-${history.away_team_id}.html" target="_blank"><img src="assets/image/soccer/teams/25x25/${history.away_team_id}.png" class="w25h25" alt="${history.away_team_name}" title="${history.away_team_name}"/> ${history.away_team_name}</a></td>
