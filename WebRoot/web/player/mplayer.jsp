...
if(type=='1'){
	...
	dw('<embed id="videoplayer" width="100%" height="260" align="absmiddle" allowfullscreen="true" allowscriptaccess="always" wmode="opaque" quality="HIGH" play="TRUE"  loop="TRUE" src="http://js.tudouui.com/bin/player2/olc_8.swf?iid='+id+'&swfPath=http://js.tudouui.com/bin/lingtong/SocialPlayer_54.swf&tvcCode=-1&autoPlay=true"/>'); 
	...
	if(link.indexOf('http://')>-1){
		dw('<embed src="'+link+'" id="object_flash_player" allowScriptAccess = "always" wmode="opaque"  pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" allowfullscreen="true" height="260" width="100%">'); 
		var url = link;
	}
	else{
		dw('<embed src="http://www.56.com/flashApp/player_open.14.09.05.d.swf?vid='+link+'&ref=www.qqzhbo.net&player_key=open&appid=3000001677" id="object_flash_player" allowScriptAccess = "always" wmode="opaque"  pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" allowfullscreen="true" height="260" width="100%">'); 
