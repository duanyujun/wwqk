...
if(type=='1'){
	...
	dw('<embed src="http://static.youku.com/v1.0.0663/v/swf/loader.swf?VideoIDS='+id+'&isAutoPlay=true&winType=index&isShowRelatedVideo=false" quality="high" width="100%" height="460" align="middle" allowScriptAccess="always" allownetworking="all" type="application/x-shockwave-flash" wmode="window" allowFullScreen="true"></embed>');
