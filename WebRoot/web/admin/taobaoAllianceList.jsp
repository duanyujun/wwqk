...
<div class="portlet light bordered">
    <div class="portlet-title">
        <div class="caption font-dark">
            ...
            <span class="caption-subject bold uppercase">淘宝联盟管理</span>
        </div>
    ...
    <div class="portlet-body">
        <div class="table-toolbar">
            <div class="row">
                <div class="col-md-6">
                    <div class="btn-group">
                        <button id="sample_editable_1_new" onclick="goInsert();" class="btn sbold green"> 添加淘宝联盟
                            <i class="fa fa-plus"></i>
                        </button>
                        <button id="deleteBtn" onclick="goDelete();" class="btn sbold red" style="margin-left:10px;display:none;"> 删除淘宝联盟
    ...
    $('#main_table').dataTable( {
        ...
        "columnDefs": [
            ...
            "render": function ( data, type, full, meta ) {
              ...
              ,{"targets":2,"orderable": true,"searchable": true},{"targets":3,"orderable": true,"searchable": true},{"targets":4,"orderable": true,"searchable": true},{"targets":5,"orderable": true,"searchable": true},{"targets":6,"orderable": true,"searchable": true},{"targets":7,"orderable": true,"searchable": true},{"targets":8,"orderable": true,"searchable": true},{"targets":9,"orderable": true,"searchable": true},{"targets":10,"orderable": true,"searchable": true},{"targets":11,"orderable": true,"searchable": true},{"targets":12,"orderable": true,"searchable": true}     
...
function goInsert(id){
	var url = "/admin/editTaobaoAlliance";
	if(id){
			 ...
			 bootbox.confirm("确定要删除?",
           	 function(o) {
               	if(o==true){
           			...
           			$.post( "/admin/deleteTaobaoAlliance",
           					{ids:ids},
           					function(result){
