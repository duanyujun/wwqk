...
<div class="portlet light bordered">
    <div class="portlet-title">
        <div class="caption font-dark">
            ...
            <span class="caption-subject bold uppercase"> 关联助攻球员 </span>
        </div>
        
    </div>
    <div class="portlet-body">
        <form class="form-horizontal" id="form" action="/admin/saveAssists163"  method="post">
		      ...
		      <div class="form-body">
		          ...
		          <div class="form-group">
		              ...
		              <div class="col-md-6">
		                  <input type="text" class="form-control" id="team_name_163" name="team_name_163" required value="${assists163.team_name_163}"  >
		              </div>
...
function initSelect(){
	...
	if('${assists163.player_id}'!=''){
		$('.bs-select').selectpicker('val', '${assists163.player_id}');
	}
}
