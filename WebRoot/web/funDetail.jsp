	...
	<div class="row clear_row_margin" style="margin-top:70px;">
		<div id="main_content" style="min-height:20px;" class="col-lg-8 col-lg-offset-2 col-md-8 col-md-offset-2 col-sm-12 col-xs-12">		
			<div class="col-lg-9 col-md-9">
				<div class="col-lg-12 col-md-12"><h2 style="font-weight:bold;">足球是最佳运动的20个简单又有趣的理由！</h2></div>
				...
				<div class="col-lg-12 col-md-12" style="margin-top:20px;">
					<blockquote style="background-color:#f3f7f0;">
						<img src="assets/image/page/quote.png">面版脚注不会从带语境色彩的面板中继承颜色和边框，因为它不是前景中的内容。面版脚注不会从带语境色彩的面板中继承颜色和边框，因为它不是前景中的内容。面版脚注不会从带语境色彩的面板中继承颜色和边框，因为它不是前景中的内容。
					</blockquote>
				</div>
				...
				<div class="col-lg-12 col-md-12" style="margin-top:10px;">
					<div class="well well-lg">
						1.这是一项全球性的运动<br>
						足球是世界上最稳定的体育运动，这项运动不被某个地区或是国家所左右。国际足联最新数据表明，全球有2.65亿足球运动员，这个数字占全世界人口的4%。像美式橄榄球(American football)这样的运动，在全世界只能是人们看着一个国家在玩。<br>
						2.规则相当简单<br>
						足球，只需要你把球弄进球网，不要用手，外加一些的越位、角球、红黄牌，仅此而已。还有比这更容易理解的事情吗。<br>
						3.有几个小物件就能去踢球<br>
						可别把足球想的太复杂了。摆个球门，有个球，就可以去踢了。球鞋很棒，这可不是必须的。<br>
					</div>
				</div>
			</div>
		</div>
