		...
		<div style="min-height:20px;" class="col-lg-8 col-lg-offset-2 col-md-8 col-md-offset-2 col-sm-12 col-xs-12">		
			<div class="col-lg-9 col-md-9">
				<div class="row">
					...
					<div class="col-lg-12 col-md-12 hidden-sm hidden-xs" style="margin-top:10px;color:#999;font-size:13px;">
						本网站内容均来自互联网，我们不提供任何直播信号和视频内容，只提供导航服务。如有侵犯您的权益请联系yutet88@163.com，广告请联系QQ：920841228
					</div>
				</div>
			</div>
